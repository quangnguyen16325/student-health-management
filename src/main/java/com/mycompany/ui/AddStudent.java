...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 0, 710, 420));
        ...
        jLabel29.setIcon(new javax.swing.ImageIcon("C:\\Users\\quang\\Documents\\NetBeansProjects\\DA_QLSKSV\\src\\main\\java\\images\\BG_Statistics.png")); // NOI18N
    ...
    private void insertStudentDetails() throws SQLException {
        try {
            ...
            student.setStudentCode(studentCodeField.getText().trim());
            student.setFullName(fullNameField.getText().trim());
            student.setBirth(birthField.getText().trim());
            student.setGender((String) genderField.getSelectedItem());
            student.setCCCD(CCCDField.getText().trim());
            student.setURLImageStudent(URLImageField.getText().trim());
            String validationMessage = validateStudentDetails(student);
        ...
        JOptionPane.showMessageDialog(this, "Error updating student details: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    
    private String validateStudentDetails(Student student) {
        ...
        if (student.getBirth().isEmpty()) {
            return "Please enter Birth!";
        }
        if (student.getCCCD().isEmpty()) {
            return "Please enter CCCD!";
        }
        if (student.getURLImageStudent().isEmpty()) {
            return "Please enter URL Image!";
        }
        return null;
    }
    
    private void insertHealthDetails() throws SQLException {
        Health health = new Health();
        health.setStudentCode(studentCodeField.getText().trim());

        String heightText = heightField.getText().trim();
        if (heightText.isEmpty()) {
            health.setHeight(0.0); 
        } else {
            health.setHeight(Double.parseDouble(heightText));
        }
        ...
        if (weightText.isEmpty()) {
            ...
            health.setWeight(Double.parseDouble(weightText));
        }

        health.setBmi(BMIField.getText().trim());
        health.setBloodType((String) bloodTypeField.getSelectedItem());
        health.setHealthCode(healthCodeField.getText().trim());
        health.setHealthStatus((String) healthStatusField.getSelectedItem());
        health.setNote(noteField.getText().trim());

        studentDAO.insertStudentHealthDetails(health);
    }

    private void insertEmergencyContactDetails() throws SQLException {
        ...
        studentDAO.insertStudentEmergencyContact(emergencyContact);
    }
