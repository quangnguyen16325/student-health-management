...
public class DetailsStudent extends javax.swing.JFrame {
    ...
    private void updateStudentDetails() throws SQLException {
        Student student = new Student();
        student.setStudentCode(studentCodeField.getText());
        student.setFullName(fullNameField.getText());
        student.setBirth(birthField.getText());
        student.setGender((String) genderField.getSelectedItem());
        student.setCCCD(CCCDField.getText());
        student.setURLImageStudent(URLImageField.getText());

        studentDAO.updateStudentDetails(takeStudentCode, student);
    }

    private void updateHealthDetails() throws SQLException {
        Health health = new Health();
        health.setStudentCode(studentCodeField.getText());
        health.setHeight(Double.parseDouble(heightField.getText()));
        health.setWeight(Double.parseDouble(weightField.getText()));
        health.setBmi(BMIField.getText());
        health.setBloodType((String) bloodTypeField.getSelectedItem());
        health.setHealthCode(healthCodeField.getText());
        health.setHealthStatus((String) healthStatusField.getSelectedItem());
        health.setNote(noteField.getText());

        studentDAO.updateStudentHealthDetails(takeStudentCode, health);
    }

    private void updateEmergencyContactDetails() throws SQLException {
        EmergencyContact emergencyContact = new EmergencyContact();
        emergencyContact.setStudentCode(studentCodeField.getText());
        emergencyContact.setFullNameContact(fullNameContactField.getText());
        emergencyContact.setRelationshipContact(relationshipContactFiled.getText());
        emergencyContact.setPhoneContact(phoneContactField.getText());
        emergencyContact.setAddressContact(addressContactField.getText());

        studentDAO.updateStudentEmergencyContact(takeStudentCode, emergencyContact);
    }
    ...
    private void loadImageButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadImageButtonActionPerformed
        String URLImageStudent = URLImageField.getText();
